...
import { hapticImpact, hapticResult, initTelegram } from './lib/telegram'
...
function errorMessage(e: unknown): string {
  if (e instanceof ApiError) {
    if (e.status === 409) return 'Не знаю такого слова'
...
function App() {
  ...
  if (loadError) {
    return (
      <div className="flex min-h-svh flex-col items-center justify-center gap-3 bg-tg-bg px-6 text-center">
  ...
  if (!gameState) {
    return (
      <div className="flex min-h-svh items-center justify-center bg-tg-bg">
